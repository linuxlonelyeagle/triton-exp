...
module attributes {"triton_gpu.num-ctas" = 1 : i32, "triton_gpu.num-warps" = 4 : i32, triton_gpu.target = "cuda", "triton_gpu.threads-per-warp" = 32 : i32} {
  tt.func public @add_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f64> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %10 = tt.splat %arg1 : !tt.ptr<f64> -> tensor<1024x!tt.ptr<f64>, #blocked>
    %11 = tt.addptr %10, %4 : tensor<1024x!tt.ptr<f64>, #blocked>, tensor<1024xi32, #blocked>
    %12 = tt.load %11, %6 : tensor<1024x!tt.ptr<f64>, #blocked>
    %13 = arith.extf %9 : tensor<1024xf32, #blocked> to tensor<1024xf64, #blocked>
    %14 = arith.addf %13, %12 : tensor<1024xf64, #blocked>
    ...
    %17 = arith.truncf %14 : tensor<1024xf64, #blocked> to tensor<1024xf32, #blocked>
    tt.store %16, %17, %6 : tensor<1024x!tt.ptr<f32>, #blocked>
    tt.return
  }
}
